...
{
    public static readonly Lazy<FieldInfo> pathInfo = new Lazy<FieldInfo>(() => AccessTools.Field(typeof(LordToil_EntitySwarm), "path"));
    public static readonly Lazy<MethodInfo> getPathInfo = new Lazy<MethodInfo>(() => AccessTools.Method(typeof(LordToil_EntitySwarm), "GetPath"));
