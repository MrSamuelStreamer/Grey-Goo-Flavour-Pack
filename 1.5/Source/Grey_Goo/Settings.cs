...
public class Settings : ModSettings
{
    ...
    public void DoWindowContents(Rect wrect)
    {
        ...
        WorldMapGooIncrementPercentPerTick = Widgets.HorizontalSlider(options.GetRect(40f), WorldMapGooIncrementPercentPerTick, 0f, 0.01f, label: "MSS_GG_Setting_GooSpreadIncrement".Translate(WorldMapGooIncrementPercentPerTick.ToString("0.000")));
        options.Gap();

        GooSpreadChance = Widgets.HorizontalSlider(options.GetRect(40f), GooSpreadChance, 0f, 10f, label: "MSS_GG_Setting_GooSpreadChance".Translate(GooSpreadChance.ToString("0.000")));
        options.Gap();
        ...
        ChanceForGooToDamagePercent = Widgets.HorizontalSlider(options.GetRect(40f), ChanceForGooToDamagePercent, 0f, 0.1f, label: "MSS_GG_Setting_ChanceForGooToDamagePercent".Translate(ChanceForGooToDamagePercent.ToString("0.000")));
        options.Gap();
